...
TF_MODELS_PATH = os.path.join(os.getcwd(), 'tf-models')
...
# Make sure to comment out #import matplotlib; matplotlib.use('Agg') in visualization_utils if you want to see the output images in UI
